    ...
    <div className="heroBg relative bg-cover bg-center h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 text-center text-white">
        <h1 className="text-4xl md:text-6xl font-bold mb-6">
          Discover Local Businesses at UNN
        </h1>
        <p className="text-lg md:text-2xl mb-8">
          Easily find services and places around the University of Nigeria,
          Nsukka.
        </p>
        <div className="flex justify-center">
          <input
            type="text"
            placeholder="Search for businesses or services on campus..."
